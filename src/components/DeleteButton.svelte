<script lang="ts">
    ...
    export let deleteFunction: MouseEventHandler<HTMLButtonElement>;
</script>

<button
	on:click|preventDefault={deleteFunction}
	class="block bg-red-400 scale-[83%] w-6 h-6 p-[2.5px] rounded">
	    <svg width="19" height="19" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<path d="M9 10H11V18H9V10ZM13 10H15V18H13V10Z" fill="white"/>
		</svg>						
</button>